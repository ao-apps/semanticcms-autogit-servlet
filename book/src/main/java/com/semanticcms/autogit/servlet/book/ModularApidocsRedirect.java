 ...
 */
package com.semanticcms.autogit.servlet.book;
...
@WebServlet("/autogit/servlet/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/autogit/servlet/apidocs/com.semanticcms.autogit.servlet/com" + Objects.toString(req.getPathInfo(), ""),
